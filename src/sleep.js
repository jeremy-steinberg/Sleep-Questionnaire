...
function generateRecommendations() {
  ...
  <p>Ensure the diagnosis is most likely to be (chronic insomnia, old name primary insomnia (other common conditions ruled out sleep screening questionnaire where all the items are no).<p>
  <p>Advise workers who drive vehicles, operate heavy machinery, or do delicate procedures, e.g. surgeons, to consider treatment during their vacation- sleep deprivation is a short-term risk.</p>
  <p>Estimate time spent in bed versus time spent asleep. If the patient cannot do this from memory, you can use a sleep diary if necessary. Ask the patient what time they go to bed and wake up. Then ask how long they spend asleep. Usually, there is a mismatch, e.g. 9 hours in bed and 6 hours asleep. I point out that they are diluting their good sleep over nine rather than 6 hours. Suggest they go to bed later and wake up simultaneously with the rest of their household. Advise the patient to do only quiet, relaxing activities before bedtime. These activities must be done outside the bed and not lying down to avoid naps, which can disrupt the routine. We recommend patients keep this new time in bed for two weeks before making any adjustments. The patient usually reports that the quality of their sleep improves as they feel they are starting to have a deep sleep and the sleep period is consolidated.</p>
  <p>After two weeks: Nothing else is needed if the patient is sleeping better and functioning well. Many patients prefer to continue on the bed restriction schedule as they find it very effective.</p>
  <p>f they are sleeping better but feel sleep deprived the next day, they may wish to add 30 minutes to their time allowed in bed for another two weeks and continue doing so until the feelings of sleep deprivation disappear while still maintaining continuous sleep at night </p>
  <p>If they are not sleeping better, they may wish to reduce their time in bed by 30 minutes (but not to less than five hours at night). They try each option for at least two weeks before making another change. If they are not sleeping better at five hours per night, you may wish to get some advice from a sleep specialist. They may need an overnight sleep study to see if there are other causes of insomnia, e.g. sleep apnea or a movement disorder.</p>
  `;
  ...
  recommendations.add("You answered yes to being a shift worker. It is recommended to see a sleep specialist if you are having sleep problems.");
  }
  ...
  recommendations.add("You answered that you drink alcohol, nicotine, or caffeine in the evenings. You should attend to this.");
  }
  ...
  recommendations.add("You may have a condition called delayed sleep phase disorder. It can be helped by using a light box in the morning and melatonin at night.");
  }
